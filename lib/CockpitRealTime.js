...
var CockpitRealTime = function() {
    function CockpitRealTime(_ref) {
        var host = _ref.host, _ref$protocol = _ref.protocol, protocol = _ref$protocol === undefined ? "refresh-protocol" : _ref$protocol;
    ...
    _createClass(CockpitRealTime, [ {
        ...
        value: function on(event, success, error) {
            if (!this.isValidEvent(event)) return console.warn("Invalid event:", event);
