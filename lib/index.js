...
var CockpitSDK = function() {
    ...
    _createClass(CockpitSDK, [ {
        ...
        value: function image(assetId) {
            ...
            var width = options.width, height = options.height, quality = options.quality, rest = _objectWithoutProperties(options, [ "width", "height", "quality" ]);
        ...
        value: function imageSrcSet(assetId) {
            ...
            if (!widths) return "";
            return widths.map(function(_ref3) {
                var srcSet = _ref3.srcSet, width = _objectWithoutProperties(_ref3, [ "srcSet" ]);
                if ((typeof width === "undefined" ? "undefined" : _typeof(width)) === "object") return _this3.image(assetId, width) + " " + (srcSet || width.width ? width.width + "w" : "");
                return _this3.image(assetId, {
                    width: width
                }) + " " + width + "w";
            }).join(", ");
        }
