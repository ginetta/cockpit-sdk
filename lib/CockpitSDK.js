...
var CockpitSDK = function () {
  ...
  _createClass(CockpitSDK, [{
    ...
    value: function fetchData(apiPath, options, queryParams) {
      ...
      var request = (0, _isomorphicFetch2.default)(hostWithToken, requestInit).then(function (x) {
        return x.json();
      });

      CockpitSDK.cache = Object.assign({}, CockpitSDK.cache, _defineProperty({}, hostWithToken, request));
      return request;
    }
